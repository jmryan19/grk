...
if __name__ == "__main__":
    ...
    #         grok_main(config)
        ...
        # CIFAR Baseline
        config = Config(data = 'cifar10', model = 'resnet18', weight_decay = 5e-4, batch_size = 64, max_epochs = 25, learning_rate = 1e-3, experiment = 'cifar_lightweight_no_shuffle', iter = i, save_dist_class_means = True, custom_cifar= False, repeat = False, kind_custom = 'top', seed = 515)
        cifar_main(config)

        config = Config(data = 'cifar10', model = 'resnet18', weight_decay = 5e-4, batch_size = 64, max_epochs = 25, learning_rate = 1e-3, experiment = 'cifar_sanity_no_shuffle', iter = i, save_dist_class_means = True, custom_cifar= False, repeat = False, kind_custom = 'top', seed = 515, sanity=True)
        cifar_main(config)
